...
<body>
	...
	<!--  
		...
		즉 requestScope.personObj.name 형태로 기술(사용)하지 않아도 된다.
	-->
	<ul>
		<!-- "속성명, 멤버변수" 형태로 기술하면, 객체의 getter()를 자동적으로
	...
	//따라서 영역에서 객체를 꺼내서 사용할때는 원래 형으로 형변환해야한다.
	...
	나이:<%=person.getAge() %>
	<!--  
	파라미터로 전달된 값을 읽을때 아래 3가지 모두 사용가능
		param.파라미터명
		param['파라미터명']
		param["파라미터명"]
	-->
