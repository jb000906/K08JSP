...
<body>
<%
//post방식으로 전송된 한글이 깨지는 현상을 처리할 때 사용한다.
request.setCharacterEncoding("UTF-8");
/*
getParameter(): input태그중 text, radio 타입처럼 하나의 값이 전송될 경우
	사용한다. 받은 값은 String 타입으로 저장된다.
getParameterValues(): input태그중 checkbox타입처럼 복수의 값이 전송될
