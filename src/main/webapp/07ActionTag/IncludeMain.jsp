...
<body>
	...
	표현식은 사용할 수 없다.(주석처리해놓은 27열 에러)
	-->
	<%@ include file="./inc/OuterPage1.jsp"%>
	<%--@ include file="<%=outerPath1OutPage1%>" --%>
	<!--  
	지시어를 통한 인클루드는 포함할 파일의 소스 자체를 그대로 현재 문서에 
	포함시킨 후 컴파일을 진행한다. 따라서 하나의 페이지라고 보면된다.
	-->
	...
	<!--  
	액션태그를 통한 인클루드는 포함할 파일을 먼저 컴파일(실행)한 후
